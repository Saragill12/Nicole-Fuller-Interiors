...
export default function NicolePage() {
  return (
    <div className="min-h-screen bg-white px-4 sm:px-10 pt-10 relative">
      ...
      {/* BIO - MOBILE PERFECT */}
      <div className="w-full max-w-sm sm:w-[300px] md:w-[350px] mt-20 sm:mt-24 md:mt-28 ml-0 sm:ml-20 px-2 sm:px-0">
        <motion.p
      ...
      <div
        className="
          ...
          space-y-12 sm:space-y-6 md:space-y-8
          w-28 sm:w-auto
          sm:items-center
          gap-16 
      ...
      >
        <motion.span
          className="text-xs sm:text-sm tracking-[0.15em] text-center rotate-0 sm:rotate-90 whitespace-nowrap"
          initial={{ opacity: 0, scale: 0.8 }}
          whileInView={{ opacity: 1, scale: 1 }}
      ...
      <motion.div
        className="
          absolute 
          bottom-6 left-1/2 sm:bottom-5 sm:right-10 sm:left-auto
          -translate-x-1/2 sm:translate-x-0
          text-center
