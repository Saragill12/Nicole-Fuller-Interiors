  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center">
        ...
        >
          <h1 className="text-center text-5xl sm:text-6xl lg:text-8xl xl:text-7xl font-serif">
            Coming soon
          </h1>
        </motion.div>
        ...
        <motion.p
          ...
          className="
            ...
            w-full sm:w-[80%] lg:w-[58%] mx-auto  leading-relaxed
          "
        >
        ...
        <motion.p
          ...
          viewport={{ once: false, amount: 0.4 }}
          className="text-center  tracking-wide text-lg lg:text-xl cursor-pointer"
        >
          View Projects
        </motion.p>
      </div>
      ...
      <div className="w-full lg:w-1/2 relative flex justify-center items-center">
        ...
        <img
          src={assets15.src}
          className="w-full sm:w-[450px] lg:w-[650px] h-[610px] object-cover relative z-10"
        />
